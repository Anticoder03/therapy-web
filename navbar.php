<?php
// Navbar component for ALIGN PEAK PHYSIO
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>ALIGN PEAK PHYSIO</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        .gradient-bg {
            background: linear-gradient(90deg, #FF8C00 0%, #FF69B4 100%);
        }
        .logo-gradient {
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="#" class="text-black hover:text-gray-600 transition-colors">Home</a>
                    <a href="#" class="text-black hover:text-gray-600 transition-colors">About us</a>
                    <a href="#" class="text-black hover:text-gray-600 transition-colors">Blogs</a>
                    <a href="#" class="text-black hover:text-gray-600 transition-colors">Gallery</a>
                    <a href="#" class="text-black hover:text-gray-600 transition-colors">Media</a>
                </nav>
    ...
    <div class="md:hidden bg-white border-t">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="mobile-menu" class="hidden pb-4">
                <a href="#" class="block py-2 text-black hover:text-gray-600">Home</a>
                <a href="#" class="block py-2 text-black hover:text-gray-600">About us</a>
                <a href="#" class="block py-2 text-black hover:text-gray-600">Blogs</a>
                <a href="#" class="block py-2 text-black hover:text-gray-600">Gallery</a>
                <a href="#" class="block py-2 text-black hover:text-gray-600">Media</a>
            </div>
        </div>
    </div>
